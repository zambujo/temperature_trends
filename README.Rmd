...
`weather_trends` compares Portugal/World temperature trends.  `weather_trends` is a _pet project_ testing how to run Python in [`{rmarkdown}`](https://github.com/rstudio/rmarkdown).
